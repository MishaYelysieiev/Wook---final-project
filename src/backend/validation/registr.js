...
const registerValidation = data => {
  ...
  errors.firstName = lengthInput(firstName, 3, 30, 'firstName should be between 2 and 30 characters');
  errors.lastName = lengthInput(lastName, 3, 30, 'lastName should be between 2 and 30 characters');
  ...
  // Empty validation
  if (Validator.isEmpty(firstName)) errors.firstName = 'firstName field is required';
  if (Validator.isEmpty(lastName)) errors.lastName = 'lastName field is required';
